...
<body>
	...
	<div class="container" align="center">
		<form name="lform"
			action="<%=request.getContextPath()%>/ModifiedqnaListInfo.do?no=${ board.board_no }"
			 method="post">
      ...
      TITLE
				...
				<div class="input-group">
					<span class="input-group-addon"> <span
						...
						placeholder="제목을 입력하세요." required="" type="text" value = "${ board.title }"/>${ board.title }<span
				...
				<div>
					<textarea class="form-control" name="content" id="content"
						...
						style="width: 100%;">${ board.content }</textarea>
					<span class="form-control-feedback glyphicon "></span>
				</div>
			</div>
