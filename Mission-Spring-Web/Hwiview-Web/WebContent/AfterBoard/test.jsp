...
<script src="<%=request.getContextPath()%>/js/modernizr.custom.32033.js"></script>
...
<body>
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="http://placehold.it/1920x450/777/fff&amp;text=REVIEW"
						alt="...">
		...
		<div class="container">
			...
			<div>
				...
				<section id="blog">
											...
											<c:forEach items="${ listpaging }" var="review"
												...
												<div style="background-color: peachpuff">
													<div class="col-sm-11 col-xs-10"
														...
														<h3>
															<a href="blog-single.html">${ review.title }</a>
														</h3>
														<div class="article-details">
															<div class="author">
																<a href="#"><i class="fa fa-user"></i>${ review.writer }</a>
															</div>
															<div class="tags">
																<i class="fa fa-tags"></i> <a href="#">reply button</a>
															</div>
														</div>
														<p class="article-data">${ review.content }</p>
					...
					class="btn btn-default btn-block m-t-md"
								...
								<div class="side-block search">
									...
									<div class="form-group has-feedback">
										<input type="text" class="form-control"
											placeholder="Search here..." value="서비스 준비중입니다...ㅠㅠ">
										<button type="submit">
	...
	<script src="<%=request.getContextPath()%>/js/jquery.circliful.min.js"></script>
	<script type="text/javascript"
...
<!-- 처음으로 돌아갓! -->
											<%-- 	<li><c:choose>
												<c:when test="${pageNo == 1}">&laquo;&laquo;
												</c:when>
												<c:otherwise>
													<a href="<%=request.getContextPath()%>/List.do?pageNo=1">&laquo;&laquo;</a></c:otherwise>
											</c:choose></li>

											<!-- 이전페이지 -->
											<li><c:choose>
												<c:when test="${beginPage == 1}">&laquo;
												</c:when>
												<c:otherwise>
													<a href="<%=request.getContextPath()%>/List.do?pageNo=${beginPage - 1}">&laquo;</a>
												</c:otherwise>
											</c:choose></li>

											<!-- 현재페이지, 갯수 -->
											<li><c:forEach var="i" begin="${beginPage}" end="${endPage}">
												<c:if test="${i eq pageNo}">
													<strong>${i}</strong>
												</c:if>
												<c:if test="${i ne pageNo}">
													<a href="<%=request.getContextPath()%>/List.do?pageNo=${i}">[${i}]</a>
												</c:if>
											</c:forEach></li>
											...
											<li><c:choose>
												...
												<c:otherwise>
													<a href="<%=request.getContextPath()%>/List.do?pageNo=${endPage + 1}">&raquo;</a>
												</c:otherwise>
											</c:choose></li>
											...
											<li><c:choose>
												...
												<c:otherwise>
													<a href="<%=request.getContextPath()%>/List.do?pageNo=${lastPage}">&raquo;&raquo;</a>
												</c:otherwise>
											</c:choose></li> --%>
