...
<body>
	...
	<div id="wrapper">
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="<%= request.getContextPath() %>/img/mypage.png"
						alt="...">
				</div>
		...
		<div align="center">
			...
			<br />
			<br />
			<h2>${ sign.id }님 회원정보</h2>
			<br />
			<br />

			<form action="<%= request.getContextPath() %>/Modified.do" method="post" name="check">
				<table style="width: 50%;">
					...
					<tr>
						<th>이메일</th>
						<td>${ sign.email_id } @ ${ sign.email_domain }</td>
					</tr>
					<tr>
						<th>전화번호</th>
						<td>${ sign.tel1 } - ${ sign.tel2 } - ${ sign.tel3 }</td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td>${ sign.post }</td>
					...
					<tr>
						<th>주소</th>
						<td>${ sign.basic_addr }</td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td>${ sign.detail_addr }</td>
					</tr>
					<tr>
						<th>가입일</th>
						<td>${ sign.reg_date }</td>
				...
				<input type="button" onclick = "doDelete()" class="btn btn-primary btn-lg" value="회원탈퇴" />
