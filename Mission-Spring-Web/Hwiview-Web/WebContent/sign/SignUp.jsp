...
<body>
	...
	<div id="wrapper">
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="<%=request.getContextPath()%>/img/images.png"
						alt="...">
				</div>
		...
		<div align="center">
			...
			<form action="<%= request.getContextPath() %>/SignInsert.do" method="post" name="check"
				onsubmit="return doSignUp()">
				<table style="width: 50%;">
					<tr>
						<th>아이디</th>
						<td><input name="signid" id="signid" type="text" class="form-control" />&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn btn-primary btn-lg" id = "idcheck"value="아이디확인"/>
						</td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td><input name="signpassword" id="signpassword" type="password" class="form-control" /></td>
					</tr>
					<tr>
						<th>비밀번호 확인</th>
						<td><input name="signpasscheck" id="signpasscheck" type="password" class="form-control" /></td>
					</tr>
					...
					<tr>
						<th>이메일</th>
						<td><input name="email_id" id="email_id" type="text" class="form-control" /> @ 
						<input name="email_domain" id="email_domain" type="text" class="form-control" /> <select
							class="form-control" name="email" onChange="javascript:selectEvent(this)">
								<option value="직접입력">
								직접입력
							</option>
					...
					<tr>
						<th>전화번호</th>
						<td><select name="tel1" class="form-control" >
								<option value="010">
								010
							</option>
								<option value="011">
						...
						</select> - <input name="tel2" id="tel2" type="text" class="form-control" /> - <input name="tel3" id="tel3" type="text" class="form-control" /></td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input name="post" id="post" type="text" class="form-control" /></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input name="basic_addr" id="basic_addr" type="text" class="form-control" /></td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td><input name="detail_addr" id="detail_addr" type="text" class="form-control" /></td>
					</tr>

				</table>
				<br /> <br /> <input type="submit" class="btn btn-primary btn-lg" value="가입완료"/>
				<input type="button" id = "back" class="btn btn-primary btn-lg" value="가입취소"/>
			</form>
		</div>
		<br/>
		<br/>
