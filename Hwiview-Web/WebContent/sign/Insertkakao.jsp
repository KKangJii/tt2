...
<body>
	...
	<div id="wrapper">
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="http://placehold.it/1920x450/777/fff&amp;text=Insert+User"
						alt="...">
		...
		<div align="center">
			...
			<form action="<%= request.getContextPath() %>/InsertkakaoInfo.do" method="post" name="check"
				...
				<table style="width: 50%;">
					...
					<tr>
						<th>이름</th>
						<td><input type = "hidden" name = "kakaoName" value = "${ kakao }"/>${ kakao }</td>
					</tr>
					<tr>
						<th>이메일</th>
						...
						<input name="email_domain" id="email_domain" type="text" class="form-control" /> <select
							name="email" class="form-control" onChange="javascript:selectEvent(this)">
								<option value="직접입력">
								직접입력
							</option>
				...
				<br /> <br /> <input type="submit" class="btn btn-primary btn-lg" value="수정완료" />
				<input type="button" id = "back" class="btn btn-primary btn-lg" value="수정취소" />
			</form>
		</div>
		<br/>
		<br/>
