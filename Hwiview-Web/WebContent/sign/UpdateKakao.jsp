...
<body>
	...
	<div id="wrapper">
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="http://placehold.it/1920x450/777/fff&amp;text=Modified"
						alt="...">
		...
		<div align="center">
			...
			<form action="<%= request.getContextPath() %>/UpdateKakaoInfo.do" method="post" name="check"
				onsubmit="return doSignUp()">
				<table style="width: 50%;">
					<tr>
						<th>아이디</th>
						<td><input name="kakaoid" id="kakaoid" type="text" class="form-control" value = "${ mykakaoVO.id }"/>
						</td>
					</tr>
					<tr>
						<th>이름</th>
					...
					<tr>
						<th>이메일</th>
						<td><input name="email_id" id="email_id" type="text" class="form-control"value = "${ mykakaoVO.email_id }" /> @ 
						<input name="email_domain" id="email_domain" type="text" class="form-control" /> <select
							name="email" onChange="javascript:selectEvent(this)">
								<option value="직접입력">
								직접입력
							</option>
					...
					<tr>
						...
						</select> - <input name="tel2" id="tel2" type="text" class="form-control" value = "${ mykakaoVO.tel2 }" /> - <input name="tel3" id="tel3" type="text" class="form-control" value = "${ mykakaoVO.tel3 }"  /></td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input name="post" id="post" type="text" class="form-control" value = "${ mykakaoVO.post }"/></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input name="basic_addr" id="basic_addr" type="text" class="form-control"value = "${ mykakaoVO.basic_addr }" /></td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td><input name="detail_addr" id="detail_addr" type="text" class="form-control" value = "${ mykakaoVO.detail_addr }"/></td>
					</tr>
