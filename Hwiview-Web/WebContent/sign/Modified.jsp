...
<body>
	...
	<div id="wrapper">
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="<%= request.getContextPath() %>/img/iloveimg_com.jpg"
						alt="...">
				</div>
		...
		<div align="center">
			...
			<form action="<%= request.getContextPath() %>/ModifiedInfo.do" method="post" name="check"
				...
				<table style="width: 50%;">
					...
					<tr>
						<th>이름</th>
						<td><input name="name" id="name" type="text" class="form-control" value = "${ sign.name }" /></td>
						
					</tr>
					<tr>
						<th>이메일</th>
						<td><input name="email_id" id="email_id" type="text" class="form-control"  value = "${ sign.email_id }" /> @ 
					...
					<tr>
						...
						</select> - <input name="tel2" id="tel2" type="text" class="form-control"  value = "${ sign.tel2 }" /> - <input name="tel3" id="tel3" type="text" class="form-control"  value = "${ sign.tel3 }" /></td>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input name="post" id="post" type="text" class="form-control"  value = "${ sign.post }" /></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input name="basic_addr" id="basic_addr" type="text" class="form-control"  value = "${ sign.basic_addr }" /></td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td><input name="detail_addr" id="detail_addr" type="text" class="form-control"  value = "${ sign.detail_addr }" /></td>
					</tr>
