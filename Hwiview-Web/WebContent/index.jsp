...
<script type='text/javascript'>
	...
	function doBuy(){
         ...
         <c:when test="${ not empty userVO or not empty kakaoVO}">
     	    location.href="<%=request.getContextPath()%>/BuyForm.do";
         </c:when>
         <c:otherwise>
		...
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img
						src="<%=request.getContextPath()%>/img/moving/oie_8135018LG3IY7wj.gif"
						alt="...">
				...
				<div class="item">
					<img
						src="<%=request.getContextPath()%>/img/moving/oie_8141161TZDfKSY.gif"
						alt="...">
					<div class="carousel-caption">
					</div>
				</div>
				<div class="item">
					<img
						src="<%=request.getContextPath()%>/img/moving/oie_814933tTcPkaZr.gif"
						alt="...">
					<div class="carousel-caption">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3">
						<a href="#" class="thumbnail"> <img
							src="<%=request.getContextPath()%>/img/package/1.png" alt="">
						</a>
						<h3>스위치 1 + 허브 1</h3>
						<p>1인 가구에서 구매하실때<br/> 추천 하는 제품입니다.</p>
						<a href="#" onclick = "doBuy()" class="btn btn-primary btn-sm">Purchase</a>
					</div>
					<div class="col-md-3">
						<a href="#" class="thumbnail"> <img
							src="<%=request.getContextPath()%>/img/package/3.png" alt="">
						</a>
						<h3>스위치 3 + 허브 1</h3>
						<p>1~2인 가구에서 구매하실때<br/> 추천 하는 제품입니다.</p>
						<a href="#" onclick = "doBuy()" class="btn btn-primary btn-sm">Purchase</a>
					</div>
					<div class="col-md-3">
						<a href="#" class="thumbnail"> <img
							src="<%=request.getContextPath()%>/img/package/5.png" alt="">
						</a>
						<h3>스위치 5 + 허브 1</h3>
						<p>3~4인 가구에서 구매하실때<br/> 추천 하는 제품입니다.</p>
						<a href="#" onclick = "doBuy()" class="btn btn-primary btn-sm">Purchase</a>
					</div>
					<div class="col-md-3">
						<a href="#" class="thumbnail"> <img
							src="<%=request.getContextPath()%>/img/package/7.png" alt="">
						</a>
						<h3>스위치 20 + 허브 4</h3>
						<p>사무실이나 공동구매 하실때 <br/>추천 하는 제품입니다.</p>
						<a href="#" onclick = "doBuy()" class="btn btn-primary btn-sm">Purchase</a>
					</div>
				</div>
			</div>
			...
			<div class="section">
				<div class="row">
					<div class="col-md-7">
						<h1>ABOUT ROOME</h1>
						<p>
							불 켜고 끄는 것이 귀찮은 일에서도,<br/> 끄는 것을 깜빡하여 걱정하는 일에서 해방될 수 있습니다.<br/> 스마트폰으로 쉽게 켜고 끄세요. <span
								class="fa fa-heart"></span>
						</p>
					</div>
					<div class="col-md-5">
						<img src="<%=request.getContextPath()%>/img/samples/ipad-bl.png" class="img-responsive"
							alt="">
					</div>
				</div>
			</div>
		...
		success : function(authObj) {
			...
			Kakao.API.request({
				...
				success : function(res) {
					...
					location.href = "<%=request.getContextPath()%>/Loginkakao.do?name="+res.properties.nickname;
				},
				fail : function(error) {
